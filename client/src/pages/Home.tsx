...
export default function Home() {
  return (
    <>
      <section className="home-hero"><div className="hero-line" /><div className="frame hero-grid"><div className="hero-copy"><p className="eyebrow">CG Tennis OS™ / Coaching operating system</p><p className="hero-kicker">A clearer way to coach</p><h1>Are you a <i>high-performing coach?</i> Build better players, faster.</h1><p className="hero-strap">Coaching Intelligence. Human Wisdom.</p><p className="hero-support">One clear operating system for coaches, players and clubs who want the important coaching work to stick.</p><div className="hero-actions"><a href="https://cgtennisos.com" target="_blank" rel="noreferrer" className="button-primary">Start your free trial <ArrowUpRight size={17} /></a><Link href="/cg-tennis-os" className="text-link">How it helps <MoveRight size={17} /></Link></div><p className="hero-trust"><Check size={15} /> Built from 39 years on court.</p></div><div className="hero-figure"><span>The coach<br />at work.</span><img src="/manus-storage/CoachCarolinepng_880be4a1.png" alt="Coach Caroline Gossage working courtside with a clipboard, tennis racket bag and coaching equipment" /></div></div><div className="hero-scroll">Scroll for the story <ArrowDown size={15} /></div></section>
